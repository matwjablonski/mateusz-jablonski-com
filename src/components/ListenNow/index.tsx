...
import { podcasts } from '../../data/external-sources.json';
    ...
    return <div className={cx(styles.listenNow, className)}>
        ...
        <div className={styles.podcasts}>
            <a
                ...
                href={podcasts.piwnicait.spotify}
                target="_blank"
            >
            ...
            <a
                className={styles.podcastLink}
                rel="noopener noreferrer nofollow"
                href={podcasts.piwnicait.applepodcast}
                target="_blank"
            >
                <div className={styles.podcast}>
            ...
            <a
                className={styles.podcastLink}
                rel="noopener noreferrer nofollow"
                href={podcasts.piwnicait.googlepodcasts}
                target="_blank"
            >
                <div className={styles.podcast}>
            ...
            <a
                className={styles.podcastLink}
                rel="noopener noreferrer nofollow"
                href={podcasts.piwnicait.youtube}
                target="_blank"
            >
                <div className={styles.podcast}>
